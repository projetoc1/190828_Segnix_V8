...
HEADERS_itead_Nextion   += NexVariable.h
HEADERS_itead_Nextion   += ADC.h
HEADERS_itead_Nextion   += gpio.h
HEADERS_itead_Nextion   += RGBled.h
HEADERS_itead_Nextion   += I2Cdev.h
HEADERS_itead_Nextion   += MPU9250.h
HEADERS_itead_Nextion   += MS5611.h
HEADERS_itead_Nextion   += Ublox.h
HEADERS_itead_Nextion   += Util.h
HEADERS_itead_Nextion   += ADC_Navio2.h
HEADERS_itead_Nextion   += Led_Navio2.h
HEADERS_itead_Nextion   += LSM9DS1.h
HEADERS_itead_Nextion   += PWM.h
...
HEADERS_itead_Nextion   += wiringSerial.h
