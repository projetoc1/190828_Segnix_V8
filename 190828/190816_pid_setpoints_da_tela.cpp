...
void* f_texto(void* data)
{
    ...
    while(1)
    {
        ...
        else
        {
            ...
            fprintf(texto,"%.2f,%.2f,%.2f,%.2f,%.2f,%.2f\n",teta,(93.066*pot1) - 28.598 - 80,setpoint,tetaz,(93.066*pot2) - 28.598 - 80,setpointz);
...
int main()
{
    ...
    while(true)
    {
        ...
        printf("y_euler = %  .2f\t y_pot = %  .2f\t z_euler = %  .2f\t z_pot = %  .2f\n",teta,(93.066*pot1) - 28.598 - 80,tetaz,(93.066*pot2) - 28.598 - 80);
    }
    return 0;
}